    ...
    return (
        <div className='choice-div'>
            ...
            <div className='choice-holder'>
                ...
                <div onClick={handleClick} className='choice'><img id='4' className='choice-img' src={flowerPic}></img></div>
                <div onClick={handleClick} className='choice'><img id='5' className='choice-img' src={circlePic}></img></div>
